...
% Edited by: William Greenbaum 10/22/2013 & Zane Zook 9/10/2015
% Desripction: Run this script after generating the raw plots.  It will 
% find all open figures and adjust line sizes and text properties.
...
%% Plotfixer Variables
plotlsize = 1.25; %thickness of plotted lines, in points
axislsize = 1.1; %thickness of tick marks and borders, in points
...
%% Plotfixer Operations
% stop changing things in this section
